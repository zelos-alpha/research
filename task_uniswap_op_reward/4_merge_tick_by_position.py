...
if __name__ == "__main__":
    ...
    order = ["position_id", "tx_type", "block_number", "transaction_hash", "block_timestamp", "pool_log_index",
    ...
    total_df.to_csv(f"{folder}{contract}-merged-all.csv", index=False)
    total_df.to_pickle(f"{folder}{contract}-merged-all.pkl")
